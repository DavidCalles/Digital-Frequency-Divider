...
-- selector[2]	=>  Location: PIN_AD17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- selector[0]	=>  Location: PIN_AG23,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- selector[1]	=>  Location: PIN_AH24,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \Counter_32bit1|DFF1|q~feeder_combout\ : std_logic;
...
SIGNAL \Counter_32bit1|DFF11|q~feeder_combout\ : std_logic;
...
SIGNAL \Counter_32bit1|DFF13|q~feeder_combout\ : std_logic;
...
SIGNAL \Counter_32bit1|DFF24|q~feeder_combout\ : std_logic;
...
SIGNAL \Counter_32bit1|DFF1|ALT_INV_q~0_combout\ : std_logic;
...
SIGNAL \Counter_32bit1|DFF11|ALT_INV_q~0_combout\ : std_logic;
SIGNAL \Counter_32bit1|DFF13|ALT_INV_q~0_combout\ : std_logic;
...
SIGNAL \Counter_32bit1|DFF24|ALT_INV_q~0_combout\ : std_logic;
...
\Counter_32bit1|DFF1|ALT_INV_q~0_combout\ <= NOT \Counter_32bit1|DFF1|q~0_combout\;
...
\Counter_32bit1|DFF11|ALT_INV_q~0_combout\ <= NOT \Counter_32bit1|DFF11|q~0_combout\;
\Counter_32bit1|DFF13|ALT_INV_q~0_combout\ <= NOT \Counter_32bit1|DFF13|q~0_combout\;
...
\Counter_32bit1|DFF24|ALT_INV_q~0_combout\ <= NOT \Counter_32bit1|DFF24|q~0_combout\;
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF0|ALT_INV_q~q\,
...
PORT MAP (
	clk => \clk~input_o\,
	asdata => \Counter_32bit1|DFF0|q~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF1|ALT_INV_q~q\,
	combout => \Counter_32bit1|DFF1|q~0_combout\);

-- Location: LABCELL_X33_Y2_N54
\Counter_32bit1|DFF1|q~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \Counter_32bit1|DFF1|q~feeder_combout\ = \Counter_32bit1|DFF1|q~0_combout\
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF1|ALT_INV_q~0_combout\,
	combout => \Counter_32bit1|DFF1|q~feeder_combout\);
...
PORT MAP (
	...
	d => \Counter_32bit1|DFF1|q~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF2|ALT_INV_q~q\,
...
PORT MAP (
	...
	asdata => \Counter_32bit1|DFF3|q~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF4|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF5|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF5|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \Counter_32bit1|DFF6|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \Counter_32bit1|DFF7|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF8|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	datac => \Counter_32bit1|DFF8|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF9|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF11|ALT_INV_q~q\,
	combout => \Counter_32bit1|DFF11|q~0_combout\);

-- Location: MLABCELL_X39_Y2_N48
\Counter_32bit1|DFF11|q~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \Counter_32bit1|DFF11|q~feeder_combout\ = ( \Counter_32bit1|DFF11|q~0_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF11|ALT_INV_q~0_combout\,
	combout => \Counter_32bit1|DFF11|q~feeder_combout\);
...
PORT MAP (
	...
	d => \Counter_32bit1|DFF11|q~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF12|ALT_INV_q~q\,
...
PORT MAP (
	...
	asdata => \Counter_32bit1|DFF12|q~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF13|ALT_INV_q~q\,
	combout => \Counter_32bit1|DFF13|q~0_combout\);

-- Location: MLABCELL_X39_Y3_N54
\Counter_32bit1|DFF13|q~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \Counter_32bit1|DFF13|q~feeder_combout\ = ( \Counter_32bit1|DFF13|q~0_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF13|ALT_INV_q~0_combout\,
	combout => \Counter_32bit1|DFF13|q~feeder_combout\);
...
PORT MAP (
	...
	d => \Counter_32bit1|DFF13|q~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF14|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF14|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \Counter_32bit1|DFF15|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF15|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF16|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF17|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF17|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF18|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \Counter_32bit1|DFF18|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF19|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF19|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF21|ALT_INV_q~0_combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF22|ALT_INV_q~q\,
...
PORT MAP (
	...
	asdata => \Counter_32bit1|DFF22|q~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Mux7~0_combout\ = ( !\selector[1]~input_o\ & ( (\Counter_32bit1|DFF22|q~q\ & (!\selector[0]~input_o\ & !\selector[2]~input_o\)) ) )
...
PORT MAP (
	...
	datab => \ALT_INV_selector[0]~input_o\,
...
-- Equation(s):
-- \Mux6~0_combout\ = ( \Counter_32bit1|DFF23|q~q\ & ( (!\selector[2]~input_o\ & (!\selector[1]~input_o\ & \selector[0]~input_o\)) ) )
...
\Counter_32bit1|DFF24|q~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \Counter_32bit1|DFF24|q~feeder_combout\ = ( \Counter_32bit1|DFF24|q~0_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF24|ALT_INV_q~0_combout\,
	combout => \Counter_32bit1|DFF24|q~feeder_combout\);
...
PORT MAP (
	...
	d => \Counter_32bit1|DFF24|q~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Mux5~0_combout\ = ( \selector[1]~input_o\ & ( \Counter_32bit1|DFF24|q~q\ & ( (!\selector[0]~input_o\ & !\selector[2]~input_o\) ) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \Counter_32bit1|DFF25|ALT_INV_q~0_combout\,
...
-- Equation(s):
-- \Mux4~0_combout\ = ( \selector[1]~input_o\ & ( \selector[0]~input_o\ & ( (\Counter_32bit1|DFF25|q~q\ & !\selector[2]~input_o\) ) ) )
...
PORT MAP (
	...
	asdata => \Counter_32bit1|DFF26|q~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Mux3~0_combout\ = ( !\selector[1]~input_o\ & ( \Counter_32bit1|DFF26|q~q\ & ( (\selector[2]~input_o\ & !\selector[0]~input_o\) ) ) )
...
-- Equation(s):
-- \Mux2~0_combout\ = ( !\selector[1]~input_o\ & ( \Counter_32bit1|DFF27|q~q\ & ( (\selector[2]~input_o\ & \selector[0]~input_o\) ) ) )
...
PORT MAP (
	...
	datab => \ALT_INV_selector[0]~input_o\,
	datae => \ALT_INV_selector[1]~input_o\,
	dataf => \Counter_32bit1|DFF27|ALT_INV_q~q\,
...
-- pragma translate_on
PORT MAP (
	dataf => \Counter_32bit1|DFF28|ALT_INV_q~q\,
...
PORT MAP (
	...
	asdata => \Counter_32bit1|DFF28|q~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Mux1~0_combout\ = ( \Counter_32bit1|DFF28|q~q\ & ( (\selector[2]~input_o\ & (\selector[1]~input_o\ & !\selector[0]~input_o\)) ) )
...
PORT MAP (
	...
	asdata => \Counter_32bit1|DFF29|q~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Mux0~0_combout\ = ( \Counter_32bit1|DFF29|q~q\ & ( (\selector[2]~input_o\ & (\selector[1]~input_o\ & \selector[0]~input_o\)) ) )
...
PORT MAP (
	...
	datab => \ALT_INV_selector[1]~input_o\,
	datac => \ALT_INV_selector[0]~input_o\,
	datae => \Counter_32bit1|DFF29|ALT_INV_q~q\,
